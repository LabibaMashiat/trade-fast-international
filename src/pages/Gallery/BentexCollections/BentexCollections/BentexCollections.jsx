...
const BentexCollections = () => {
  ...
  <p className="text-center text-lg text-gray-700 max-w-3xl mx-auto mb-12 text-justify">
    Trade Fast International proudly sources a wide range of premium collections from Bentex —  
    an esteemed international supplier known for quality textile accessories including buttons, elastics, metal accessories, laces, zippers, and catalogues.  
    Explore our curated Bentex gallery showcasing diverse product categories, reflecting the partnership that brings global sourcing excellence directly to you.
  </p>
</section>
            <section>
