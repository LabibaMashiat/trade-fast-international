...
import { FaPhoneAlt, FaEnvelope, FaMapMarkerAlt, FaGlobeAsia, FaFlag } from "react-icons/fa";
  ...
  return (
    <div className="min-h-screen bg-base-100 py-10 px-4 md:px-16 lg:px-32">
      ...
      <div className="text-center mb-12">
        <h2 className="sm:text-3xl md:text-4xl font-semibold mb-2">Contact</h2>
        <hr />
        ...
        <div className="mt-4 flex flex-col items-center gap-2">
          ...
          <p className="flex items-center gap-2">
            ...
            <a href="mailto:showkot@tradefastint.com" className="text-blue-500 hover:underline">
